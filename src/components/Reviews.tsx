...
export default function Reviews({ data }: { data: ReviewsProp }) {
    ...
    <section>
      <div className="overflow-hidden bg-transparent">
        <div className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          <div className="max-w-2xl w-full mb-6 sm:mb-10 md:mb-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl text-white font-semibold text-center">
          ...
          >
            {data.map((item, i) => (
              <SwiperSlide className="flex h-auto" key={i}>
                <div className="flex flex-col bg-gray-800/10 rounded-xl">
                  ...
                  <div className="p-4 rounded-b-xl md:px-7 bg-slate-900/50">
                    <div className="flex items-center">
                      <div className="flex-shrink-0">
                        <img
                          className="h-8 w-8 rounded-full object-cover sm:h-[2.875rem] sm:w-[2.875rem]"
                          src={item.imgUrl}
