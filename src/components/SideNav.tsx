        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <MdLightMode
                style={{ color: theme === 'dark' ? '#E2FFD7' : '#000' }}
            ...
            {user.fullName !== '' && (
              <>
                <li>
                  ...
                  >
                    <svg
                      className="flex-shrink-0 w-[1.2rem] h-[1.2rem] text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      viewBox="0 0 18 18"
